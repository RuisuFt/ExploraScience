...
// Fetch moderate questions without duplicates
$moderateQuestions = getUniqueQuestions('moderate', 10, $selectedIds);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Moderate Challenge</title>
</head>
<body>
    <div class="top-bar">
    ...
    <div class="body-question">
        <form method="POST" action="submit_answer.php">
            <div class="questions-container">
                ...
                foreach ($moderateQuestions as $row) {
